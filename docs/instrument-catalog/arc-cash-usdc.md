# Instrument fact sheet — arc-cash-usdc
...
- Adapter and manifest versions: cash-arc-mainnet 0.0.0 (reserved identity, mechanics not implemented); manifest 0.1.0.

## Economic mechanics

- Purpose: Unverified future Arc mainnet USDC.
